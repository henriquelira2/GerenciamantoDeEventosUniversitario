...
export const CreateEventSchema = yup.object().shape({
  ...
  dateEventStart: yup.string().required("Preencha o campo!"),
  dateEventEnd: yup.string().required("Preencha o campo!"),
  hourEventStart: yup.string().required("Preencha o campo!"),
  hourEventEnd: yup.string().required("Preencha o campo!"),
  ...
  durationEvent: yup.string().required("Preencha o campo!"),
